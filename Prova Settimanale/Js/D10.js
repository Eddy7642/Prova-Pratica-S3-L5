...
console.log(isThisAnEmail("epi@code.com"));
console.log(isThisAnEmail("epi.code"));     
...
function whatDayIsIt() {
  // Crea un nuovo oggetto Date che rappresenta la data e l'ora correnti
  let now = new Date();
...
function howManyDays(date) {
  const giorniPassati = new Date(date);
  const giornoCorrente = new Date();
  const differenza = giornoCorrente - giorniPassati ;
...
console.log(deleteProp(mioOggetto, "anni"));
...
function clearList() {
  // Trova l'elemento della lista non ordinata tramite l'ID
  var myList = document.getElementById('myList');

  // Rimuovi tutti i figli dell'elemento della lista
...
function addClassToAllTR() {
  ...
  console.log("test aggiunto a tutti i tag <tr>.");
}
